...
public class GuruStepDefinitions {
    ...
    public void sutunundaki_tum_degerleri_yazdirir(String istenenSutun) {
        ...
        //dolayisi ile bu webelementlerden hangisi
        ...
        // loop biitginde basligin bulunup bulunmadigini kontrol etmek ve
        ...
        if (istenenBaslikIndexi!=-3){ // baslik bulundu
            List<WebElement> istenenSutundakiElementler=
                    Driver.getDriver().findElements
                            (By.xpath("//tbody//tr//td["+istenenBaslikIndexi+"]"));
            for (WebElement each:istenenSutundakiElementler
                 ) {
                System.out.println(each.getText());
            }
        }else {
            System.out.println("istenen baslik bulunamadi");  //baslik bulunamadi
        }
    }
}
